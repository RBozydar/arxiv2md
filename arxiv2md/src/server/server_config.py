...
APP_REPOSITORY = os.getenv("APP_REPOSITORY", "https://github.com/arxiv2md/arxiv2md")
APP_VERSION = os.getenv("APP_VERSION", "unknown")
APP_VERSION_URL = os.getenv("APP_VERSION_URL", "https://github.com/arxiv2md/arxiv2md")
